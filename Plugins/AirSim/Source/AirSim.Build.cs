...
public class AirSim : ModuleRules
{
    ...
    public AirSim(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "ImageWrapper", "RenderCore", "RHI", "AssetRegistry", "PhysicsCore", "PhysXVehicles", "PhysXVehicleLib", "PhysX", "APEX", "Landscape", "CinematicCamera", "UAVNetSim"});
        PrivateDependencyModuleNames.AddRange(new string[] { "UMG", "Slate", "SlateCore", "Json", "JsonUtilities" });

        CircularlyReferencedDependentModules.AddRange(new string[] { "UAVNetSim" });
        ...
        PublicIncludePathModuleNames.Add("UAVNetSim");
