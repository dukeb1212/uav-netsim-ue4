...
public class UAVNetSim : ModuleRules
{
	public UAVNetSim(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        string VcpkgRootPath = "E:/UAVNetSim/vcpkg_installed";
        ...
        RuntimeDependencies.Add(Path.Combine(VcpkgBinariesPath, "turbojpeg.dll"));
        RuntimeDependencies.Add(Path.Combine(VcpkgBinariesPath, "jpeg62.dll"));
        ...
        PublicAdditionalLibraries.Add(Path.Combine(VcpkgLibraryPath, "turbojpeg.lib"));
        PublicAdditionalLibraries.Add(Path.Combine(VcpkgLibraryPath, "jpeg.lib"));
